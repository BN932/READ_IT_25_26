    ...
    <div class="col-md-6">
      ...
      <form class="flex-col" action="users/create" method="POST" enctype="application/x-www-form-urlencoded">
        <div class="flex-col">
          ...
          <input type="password" id="psw" name="password" placeholder="Create here a strong password" />
